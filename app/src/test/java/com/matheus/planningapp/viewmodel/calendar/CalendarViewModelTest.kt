...
class CalendarViewModelTest {
    ...
    @Test
    fun `insertCalendar with empty name should emit ShowError event`() = runTest {
        // Given
    ...
    @Test
    fun `insertCalendar with blank name should emit ShowError event`() = runTest {
        // Given
        val calendarEntity = CalendarEntity(name = "   ", isDefault = false)
        val events = mutableListOf<DatabaseUiEvent>()
    ...
    @Test
    fun `insertCalendar with valid name should call repository insertCalendar and emit Saved event`() = runTest {
        // Given
    ...
    @Test
    fun `insertCalendar with default calendar should set all defaults to false first`() = runTest {
        // Given
    ...
    @Test
    fun `insertCalendar with duplicate name should emit ShowError event`() = runTest {
        // Given
    ...
    @Test
    fun `updateCalendar with empty name should emit ShowError event`() = runTest {
        // Given
    ...
    @Test
    fun `updateCalendar with blank name should emit ShowError event`() = runTest {
        // Given
        val calendarEntity = CalendarEntity(id = 1, name = "    ", isDefault = false)
        val events = mutableListOf<DatabaseUiEvent>()
    ...
    @Test
    fun `updateCalendar with valid name and non-default calendar should call repository updateCalendar`() = runTest {
        // Given
    ...
    @Test
    fun `updateCalendar with default calendar should set all defaults to false first`() = runTest {
        // Given
    ...
    @Test
    fun `updateCalendar removing default status should emit ShowError event`() = runTest {
        // Given
    ...
    @Test
    fun `updateCalendar making a non-default calendar as default should work`() = runTest {
        // Given
    ...
    @Test
    fun `deleteCalendar with default calendar should emit ShowError event`() = runTest {
        // Given
    ...
    @Test
    fun `deleteCalendar with non-default calendar should call repository deleteCalendar and emit Saved event`() = runTest {
        // Given
    ...
    @Test
    fun `calendars should emit initial list from repository`() = runTest {
        // When & Then

...
class RecurrenceViewModelTest {
    ...
    private val initialRecurrences =
        listOf(
    ...
    @Test
    fun `getRecurrencesByCalendar should return empty list when no recurrences exist`() =
        runTest {
            // Given
            val calendarId = 1L
    ...
    @Test
    fun `deleteRecurrence with existing recurrence should call repository delete`() =
        runTest {
            // Given
            val recurrenceId = 1L
    ...
    @Test
    fun `deleteRecurrence with non-existing recurrence should not call repository delete`() =
        runTest {
            // Given
    ...
    @Test
    fun `uiState should update when calendars change`() =
        runTest {
            // Given
            val newCalendars =
                listOf(

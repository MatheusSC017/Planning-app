...
class CalendarRepositoryImplTest {
    ...
    @Test
    fun `insertCalendar should call dao insert and return id`() = runTest {
        // Given
    ...
    @Test
    fun `updateCalendar should call dao updateWithDateTime`() = runTest {
        // Given
    ...
    @Test
    fun `deleteCalendar should call dao delete`() = runTest {
        // Given
    ...
    @Test
    fun `getCalendars should return flow from dao`() = runTest {
        // Given
    ...
    @Test
    fun `getCalendarById should call dao getCalendarById and return result`() = runTest {
        // Given
        val calendarId = 1L
    ...
    @Test
    fun `ensureDefaultCalendarExists should insert default calendar if count is zero`() = runTest {
        // Given
    ...
    @Test
    fun `ensureDefaultCalendarExists should not insert if count is greater than zero`() = runTest {
        // Given
    ...
    @Test
    fun `setAllDefaultAsFalse should call dao setAllDefaultAsFalse`() = runTest {
        // Given

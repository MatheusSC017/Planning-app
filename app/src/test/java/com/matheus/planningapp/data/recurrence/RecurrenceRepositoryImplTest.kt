...
class RecurrenceRepositoryImplTest {
    ...
    @Test
    fun `insert should call dao insert`() =
        runTest {
            // Given
    ...
    @Test
    fun `getRecurrenceById should call dao getRecurrenceById and return result`() =
        runTest {
            // Given
            val recurrenceId = 1L
            val recurrenceEntity =
    ...
    @Test
    fun `getRecurrenceByCalendar should return flow from dao`() =
        runTest {
            // Given
            val calendarId = 1L
            val recurrences =
    ...
    @Test
    fun `getRecurrenceByCommitment should call dao getRecurrenceByCommitment and return result`() =
        runTest {
            // Given
            val commitmentId = 1L
            val recurrenceEntity =

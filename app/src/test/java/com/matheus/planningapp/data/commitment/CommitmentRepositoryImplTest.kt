...
class CommitmentRepositoryImplTest {
    ...
    @Test
    fun `getCommitment should call dao getCommitment and return result`() = runTest {
        // Given
        val commitmentId = 1L
    ...
    @Test
    fun `getCommitmentsForDay should return flow from dao`() = runTest {
        // Given
    ...
    @Test
    fun `insertCommitment should call dao insert and return id`() = runTest {
        // Given
        val commitmentEntity = CommitmentEntity(
            calendar = 1,
            title = "Test Commitment",
    ...
    @Test
    fun `updateCommitment should call dao update`() = runTest {
        // Given
        val commitmentEntity = CommitmentEntity(
            id = 1,
    ...
    @Test
    fun `deleteCommitment should call dao delete`() = runTest {
        // Given
        val commitmentEntity = CommitmentEntity(
            id = 1,
    ...
    @Test
    fun `checkSchedulingConflictsBetweenCommitments should call dao with correct parameters`() = runTest {
        // Given
        ...
        coEvery { commitmentDao.checkSchedulingConflictsBetweenCommitments(any(), any(), any(), any(), any(), any()) } returns expectedConflictCount
    ...
    @Test
    fun `getFutureCommitments should call dao getFutureCommitments and return result`() = runTest {
        // Given
    ...
    @Test
    fun `getCommitmentByRecurrence should return flow from dao`() = runTest {
        // Given
        val calendarId = 1L
